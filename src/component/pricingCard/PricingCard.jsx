...
export default function PricingCard({
  ...
  return (
    <div className=" w-[280px] h-full">
      <div className="flex flex-col relative p-6 mx-auto max-w-lg text-center text-gray-900 h-[370px] bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
