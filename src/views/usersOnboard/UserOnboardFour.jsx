...
import { getProfAreasByWorkSpace, getProvinces, getUserGenericForm, getWorkspace } from "../../utils/api";
  ...
  // }
    ...
    useEffect(()=>{
      ...
      getUserGenericForm(payload).then((res)=> {
        // const myData = JSON.parse(res.payload[0].generic_forms)
        // console.log(myData);
       setFormData(res.payload[0]?.generic_forms)
      })
